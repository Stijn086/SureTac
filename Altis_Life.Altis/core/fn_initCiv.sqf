...
reb_spawn_1 = nearestObjects[getMarkerPos  "reb_spawn_1", [""],250];
reb_spawn_2 = nearestObjects[getMarkerPos  "reb_spawn_2", [""],250];
reb_spawn_3 = nearestObjects[getMarkerPos  "reb_spawn_3", [""],250];
